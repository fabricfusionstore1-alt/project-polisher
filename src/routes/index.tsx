...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Glowaura-B3 — Skin Whitening & Serum Body Cream" },
      {
        name: "description",
        content:
          "Glowaura-B3 Skin Whitening & Serum Body Cream — an advanced formula for skin lightening & brightening, for men & women, all skin types. Discover the full Glowaura-B3 collection.",
      },
      { property: "og:title", content: "Glowaura-B3 — Skin Whitening & Serum Body Cream" },
      {
        property: "og:description",
        content:
          "Advanced formula for skin lightening & brightening. Visible results in 7 days. For men & women, all skin types.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Product",
          name: "Glowaura-B3 Skin Whitening & Serum Body Cream",
          brand: { "@type": "Brand", name: "Glowaura-B3" },
          description:
            "Advanced formula body cream for skin lightening & brightening. For men & women, all skin types.",
          countryOfOrigin: "IN",
          offers: {
            "@type": "Offer",
            priceCurrency: "INR",
...
const nightCream = {
  ...
  price: "₹899",
  description:
    "An overnight treatment cream that works while you sleep — an advanced formula for acne and dark spot care, with visible results in 7 days. Suited to all skin types, for men and women.",
  specs: [
    { label: "Net Weight", value: "30 g" },
    { label: "M.R.P.", value: "₹899 (incl. taxes)" },
  ...
  usage:
    "Cleanse and pat the face dry at night. Take a small amount and massage gently over the face and neck in upward circular motions until absorbed. Leave on overnight and rinse in the morning. Patch test behind the ear before first use; for external use only.",
};
          ...
          <div className="mx-auto w-full max-w-6xl px-5 sm:px-7 lg:px-8 relative grid items-center gap-10 py-12 sm:gap-12 sm:py-20 lg:grid-cols-2 lg:py-28">
            <div className="text-center lg:text-left">
              ...
              <p className="animate-rise-late mx-auto mt-4 max-w-xl text-pretty text-base font-light leading-relaxed text-muted-foreground sm:mt-6 sm:text-xl lg:mx-0">
                Skin Whitening &amp; Serum Body Cream — an advanced formula for skin lightening
                &amp; brightening, crafted for men &amp; women and every skin type.
              </p>
              ...
              <div className="animate-rise-latest glass-card ring-gold mt-7 w-full rounded-2xl border border-gold/40 px-5 py-5 text-center sm:mt-10 sm:inline-block sm:w-auto sm:px-7 lg:text-left">
                ...
                <p className="mt-1 text-[0.7rem] font-light text-muted-foreground sm:text-xs">
                  Rupees One Thousand Forty Nine Only · Net Qty: 1 N
                </p>
                <p className="mt-1 text-[0.7rem] font-light text-muted-foreground sm:text-xs">
                  Net Weight: 250 g
                </p>
            ...
            <figure className="animate-rise-late">
              <SmartImage
                src={heroImg}
                alt="Glowaura-B3 Skin Whitening & Serum Body Cream jar beside its black and gold box on black marble"
        ...
        >
          <Reveal>
            <SectionHeading
              ...
              title="Skin Whitening & Serum Body Cream"
            />
          </Reveal>
          ...
          <div className="mt-10 grid items-start gap-9 sm:mt-14 sm:gap-12 lg:grid-cols-2">
            <Reveal as="figure">
              <SmartImage
                src={creamOpenImg}
                alt="Glowaura-B3 Skin Whitening & Serum Body Cream open jar with lid beside it"
                wrapperClassName="shadow-luxe aspect-[3/4] w-full overflow-hidden rounded-2xl border border-border"
            ...
            <Reveal delay={120}>
              ...
              <p className="mt-4 text-[0.92rem] font-light leading-relaxed text-muted-foreground sm:mt-5 sm:text-base">
                The signature 2-in-1 cream and serum that lightens, brightens and deeply hydrates
                the whole body with Niacinamide (Vitamin B3).
              </p>
              ...
              <dl className="mt-8 grid grid-cols-2 gap-x-5 gap-y-4 border-t border-border/60 pt-6 sm:mt-10 sm:gap-x-8">
                {[
                  ...
                  { label: "M.R.P.", value: "₹1,049 (incl. taxes)" },
                  { label: "Unit Price", value: "₹5.245 / gram" },
                  { label: "Skin Types", value: "All skin types" },
                  { label: "For", value: "Men & Women" },
                  { label: "Origin", value: "Made in India" },
                ].map((s) => (
              ...
              <div className="card-luxe glass-card ring-gold mt-8 w-full rounded-2xl border border-gold/40 px-5 py-5 text-center sm:mt-10 sm:inline-block sm:w-auto sm:px-7 sm:text-left">
                ...
                <p className="mt-1 text-[0.7rem] font-light text-muted-foreground sm:text-xs">
                  Net Weight 250 g · ₹5.245 per gram
                </p>
              </div>
              ...
              <p className="mt-3 text-[0.92rem] font-light leading-relaxed text-muted-foreground sm:text-base">
                Apply a generous amount to clean, dry skin and massage in gentle circular motions
                until fully absorbed. Use twice daily — morning and evening — for best results.
                Suitable for the whole body, including hands, elbows, knees, and areas prone to
                dullness.
              </p>
            </Reveal>
          </div>
          ...
          <div className="mx-auto w-full max-w-6xl px-5 sm:px-7 lg:px-8 relative py-14 sm:py-20 lg:py-28">
            ...
            <div className="mt-10 grid items-center gap-9 sm:mt-14 sm:gap-12 lg:grid-cols-2">
              <Reveal as="figure" className="animate-gold-pulse rounded-2xl">
                ...
                />
                <figcaption className="mt-3 text-center text-[0.6rem] uppercase tracking-[0.22em] text-muted-foreground sm:mt-4 sm:text-xs sm:tracking-[0.25em]">
                  Crystal jar &amp; maroon gift box · 30 g
                </figcaption>
              </Reveal>
              ...
              <Reveal delay={120}>
                ...
                <h3 className="mt-3 text-balance font-display text-2xl font-semibold text-ivory sm:text-3xl lg:text-4xl">
                  Advanced Formula for Acne &amp; Dark Spot Care
                </h3>
                <p className="mt-4 text-[0.92rem] font-light leading-relaxed text-muted-foreground sm:mt-5 sm:text-base">
                  {nightCream.description}
                </p>

                <ul className="mt-6 space-y-3 sm:mt-8">
                  {nightCream.benefits.map((b) => (
                    <li key={b} className="flex items-start gap-3 sm:gap-4">
                      <span
                        className="mt-2 h-1.5 w-1.5 shrink-0 rotate-45 bg-gold"
                        aria-hidden="true"
                ...
                <div className="card-luxe glass-card ring-gold mt-8 w-full rounded-2xl border border-gold/40 px-5 py-5 text-center sm:mt-10 sm:inline-block sm:w-auto sm:px-7 sm:text-left">
                  ...
                  <p className="mt-1 text-[0.7rem] font-light text-muted-foreground sm:text-xs">
                    Net Weight 30 g · ₹29.96 per gram
                  </p>
                </div>
